...
export function HeroImage({ src, alt, mobileSrc }: Props) {
  ...
  if (mobileSrc) {
    const mobile = assetPath(mobileSrc);
    ReactDOM.preload(mobile, { as: "image", fetchPriority: "high", media: "(max-width: 900px)" } as Parameters<typeof ReactDOM.preload>[1]);
  }
